...
Vou fazer um gráfico dessa série.
...
(a)- Utilize o IPCA e calcule a variação da inflação nesse período, $$π_t − π_{t−1}$$. \

Então vou fazer a primeira diferença da inflação e salvar em objeto chamado dinf:
...
Agora vou fazer o gráfico dessa série, que é o item b.
...
$$\frac{(\mu + z)}{\alpha} = 6,9\%/0.007 = 985,71$$


Em outras palavras: a evidência sugere que, desde 2012, no Brasil, a taxa média de desemprego necessária para manter a inflação constante é igual a 985%.
